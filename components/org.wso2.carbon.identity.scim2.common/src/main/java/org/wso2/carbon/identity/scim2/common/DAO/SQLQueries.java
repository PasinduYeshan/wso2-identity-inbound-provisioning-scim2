...
public class SQLQueries {
    ...
    public static final String ADD_ASYNC_OPERATION_SQL =
            "INSERT INTO IDN_ASYNC_OPERATION (ASYNC_OP_ID, TENANT_ID, STATUS, MESSAGE) VALUES (?, ?, ?)";

    public static final String UPDATE_ASYNC_OPERATION_SQL =
            "UPDATE IDN_ASYNC_OPERATION SET STATUS=?, MESSAGE=? WHERE ASYNC_OP_ID=?";

    public static final String GET_ASYNC_OPERATION_SQL =
            "SELECT TENANT_ID, STATUS, MESSAGE FROM IDN_ASYNC_OPERATION WHERE ASYNC_OP_ID=?";
